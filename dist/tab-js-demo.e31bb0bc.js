...
var content = [["React is extremely popular", "It makes building complex, interactive UIs a breeze", "It's powerful & flexible", "It has a very active and versatile ecosystem"], ["Components, JSX & Props", "State", "Hooks (e.g., useEffect())", "Dynamic rendering"], ["Official web page (react.dev)", "Next.js (Fullstack framework)", "React Native (build native mobile apps with React)"]];
var btnWhyReact = document.getElementById("btn-why-react");
var btnCoreFeature = document.getElementById("btn-core-features");
...
//# sourceMappingURL=/tab-js-demo.e31bb0bc.js.map